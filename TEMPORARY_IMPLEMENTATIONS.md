...
3. `IRegistrationQueue`
   ...
   * **Engineering Truthfulness:** It generates an explicitly labeled synthetic development token (`DEV-SYNTHETIC-*`) for layout and terminal verification. It is strictly not presented as a production security implementation.